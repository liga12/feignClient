...
insert into school (id, address, name) values (4, 'address45', 'name42');
insert into school (id, address, name) values (5, 'address55', 'name54');
...
insert into student_ids (school_id, student_ids) values (4, '1');
insert into student_ids (school_id, student_ids) values (4, '2');

insert into student_ids (school_id, student_ids) values (5, '71');