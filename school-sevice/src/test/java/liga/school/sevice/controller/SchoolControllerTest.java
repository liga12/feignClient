...
//        when(schoolService.getAll(schoolFindDto)).thenReturn(schoolDtos);
//
//        mockMvc.perform(post("/school/").contentType(MediaType.APPLICATION_JSON).content(mapToJson(schoolFindDto)))
...
//
//        verify(schoolService).getAll(schoolFindDto);
//    }
//
//    @Test
